...
def crop_image(self, img: np.ndarray, left_crop, right_crop, top_crop, bottom_crop) \
        -> np.ndarray:
    return img[top_crop:bottom_crop, left_crop:right_crop]


def crop_boxes(self, boxes: BoundingBoxes, left_crop, right_crop, top_crop, bottom_crop) \
        -> BoundingBoxes:
